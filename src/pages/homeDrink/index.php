...
<body>
    ...
    <nav class="navbar">
        <a href="/projeto/pizza/src/pages/home/index.php" class="nav-button ">Pizzas</a>
        <button class="nav-button active">Bebidas</button>
    </nav>
    <h2>Cardápio:</h2>
    <section class="menu">
    <?php 
        ...
        $res = mysqli_query($_con, "SELECT * FROM tb_bebida");
        ...
        echo '
            ...
            if(isset($_POST['ver'])) {
                ...
                $consulta = mysqli_query($_con, "SELECT * FROM tb_bebida WHERE tb_produto_id_produto = $produto_id_selecionado");
